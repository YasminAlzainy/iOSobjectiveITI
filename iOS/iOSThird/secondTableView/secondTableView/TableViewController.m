...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.section) {
        case 0:
            infoView.age= [[males objectAtIndex:indexPath.row] age];
            infoView.email = [[males objectAtIndex:indexPath.row] email];
            infoView.phone = [[males objectAtIndex:indexPath.row] phone];
            [self.navigationController pushViewController:infoView animated:YES];
            
            printf("Males \n");
            break;
        case 1:
            infoView.age= [[females objectAtIndex:indexPath.row] age];
            infoView.email = [[females objectAtIndex:indexPath.row] email];
            infoView.phone = [[females objectAtIndex:indexPath.row] phone];
            [self.navigationController pushViewController:infoView animated:YES];
